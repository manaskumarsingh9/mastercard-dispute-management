...
# Urgency
urgency.buffer-days=2
urgency.critical-days=3
urgency.warning-days=7
...
> **Known issue**: Gemini rejects requests exceeding 1M tokens. Claims with very large evidence sets may fail enrichment/rebuttal generation. Monitor for `429` or `token limit` errors.
